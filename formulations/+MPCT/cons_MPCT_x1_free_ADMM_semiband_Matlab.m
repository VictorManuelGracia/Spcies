%% cons_MPCT_x1_free_ADMM_Matlab
%
% Generates the constructor for Matlab of the MPCT_x1_free formulation solved using ADMM.
%
...
%             The specifics of the fileds of this recipe can be found in cons_MPCT_x1_free_ADMM_C.m
%
% OUTPUTS:
...
function constructor = cons_MPCT_x1_free_ADMM_semiband_Matlab(recipe)
    ...
    constructor_C = MPCT.cons_MPCT_x1_free_ADMM_semiband_C(recipe_C);
    ...
    constructor.files.mex_code.blocks = {'$START$',[this_path '/struct_MPCT_x1_free_ADMM_semiband_C_Matlab.c']};
